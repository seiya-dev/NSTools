...
# SET ENVIRONMENT
squirrel_dir = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '..'))

NSCB_dir = os.path.abspath(os.path.join(squirrel_dir, '..'))

ztools_dir = squirrel_dir
zconfig_dir = os.path.join(squirrel_dir, 'zconfig')
